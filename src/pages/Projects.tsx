      ...
      <header className="border-b border-border/50 bg-background/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-foreground">Crealy</span>
          </Link>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-1">Créez et gérez vos sites web générés par IA</p>
            </div>
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              ...
              <DialogContent>
                ...
                <div className="space-y-4 pt-4">
                  <Input
                    placeholder="Nom du projet (ex: Mon Restaurant)"
              ...
              {projects.map((project) => (
                ...
                >
                  ...
                  {project.business_type && (
                    <span className="inline-block px-2 py-0.5 rounded-full bg-secondary text-xs text-muted-foreground mb-2">
                      {project.business_type}
                    </span>
                  )}
